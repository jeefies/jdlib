...
set shortmess=aoO
badd +92 include/jdlib.h
badd +233 src/jdlist.c
badd +76 test/test_jlist.c
badd +1 src/jdstr.c
badd +9 test/test_jstrs.c
badd +8 src/jdlib.c
argglobal
%argdel
$argadd include/jdlib.h
$argadd src/jdlist.c
$argadd test/test_jlist.c
set stal=2
...
silent! normal! zE
let &fdl = &fdl
let s:l = 76 - ((21 * winheight(0) + 18) / 37)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 77 - ((19 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 77
...
silent! normal! zE
let &fdl = &fdl
let s:l = 116 - ((5 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 116
...
wincmd w
argglobal
if bufexists("src/jdlib.c") | buffer src/jdlib.c | else | edit src/jdlib.c | endif
balt src/jdlist.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
silent! normal! zE
let &fdl = &fdl
let s:l = 100 - ((8 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 100
...
wincmd w
argglobal
if bufexists("src/jdstr.c") | buffer src/jdstr.c | else | edit src/jdstr.c | endif
balt include/jdlib.h
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
