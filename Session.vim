...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 0 + 20) / 40)
exe '2resize ' . ((&lines * 35 + 20) / 40)
exe '3resize ' . ((&lines * 0 + 20) / 40)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 84 - ((21 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 84
...
silent! normal! zE
let &fdl = &fdl
let s:l = 126 - ((6 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 126
...
silent! normal! zE
let &fdl = &fdl
let s:l = 322 - ((13 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 322
...
silent! normal! zE
let &fdl = &fdl
let s:l = 100 - ((6 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 100
