...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 141 - ((17 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 141
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 92 - ((11 * winheight(0) + 6) / 13)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 92
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 71 - ((11 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 71
...
tabnext 2
set stal=1
badd +87 include/jdlib.h
badd +30 src/jdlist.c
badd +20 test/test_jlist.c
badd +1 src/jdstr.c
